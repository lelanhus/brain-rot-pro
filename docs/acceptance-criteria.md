...
A milestone is **done** when _all_ its 🤖 criteria pass `verify` **and** its 👤 criteria are confirmed.
...
**Goal:** prove Wikipedia can become cards that are _fun to scroll_, before building any pipeline. ~150–200 hand-/AI-curated cards, dead-simple vertical feed, **no auth, no personalization, no concept graph**.
...
- Reaction is repeatedly _"that was interesting, show me another"_ — not _"this reads like chopped-up Wikipedia."_
...
- Generated cards are _consistently_ interesting enough to approve; low rate of unsupported/awkward claims on review.
